...
# SecretEnv2 has 2097152 states; a single full sweep of Iterative Policy Evaluation
# needs S*A*S*R calls to env.p(...), which is not tractable through the ctypes
# wrapper (nor conceivably tractable at all at this scale). Only model-free
# (MC/TD/Planning) methods are used, as explicitly allowed by the syllabus
# ("quand possible").
